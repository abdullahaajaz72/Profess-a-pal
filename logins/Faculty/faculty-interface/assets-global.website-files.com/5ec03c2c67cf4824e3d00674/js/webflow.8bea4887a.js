                    ...
                    case zx:
                        {
                            ...
                            c = e;
                            return (0, oi.getIn)(c, [r, n]) !== n && (c = tE(c, n, a, r, i)),
                            Fa(c, r, s, o, i)
                        }
                    case Yx:
                        {
                ...
                case gr:
                    {
                        let s = i(e, ft),
                            c = i(e, dt),
                            f, p;
                        return n.config.widthUnit === Ct ? f = DE.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0, Rt.default)(parseFloat(s), parseFloat(r.width)),
                        n.config.heightUnit === Ct ? p = DE.test(c) ? parseFloat(c) : parseFloat(r.height) : p = (0, Rt.default)(parseFloat(c), parseFloat(r.height)),
                        {
                            widthValue: f,
                            heightValue: p
                        }
