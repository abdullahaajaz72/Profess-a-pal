...
<head>
    ...
    <title>Restricted Roll No's And Emails </title>
    <style>
        body {
...
?>
        ...
        <body>
            <div class="container">
                <div class="card">
                    <div class="header">
                        <h1>Restricted Roll No's And Emails </h1>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Roll No's / Emails</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php

                                $sql = "SELECT emails AS data FROM staff_emails WHERE restricted = 1 UNION SELECT roll_nos AS data FROM rollnos WHERE restricted = 1";
